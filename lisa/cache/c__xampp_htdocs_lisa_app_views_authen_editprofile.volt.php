			...
			<div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <?= $this->tag->textField(['username', 'size' => 32, 'class' => 'input-group', 'required' => true, 'value' => $viewProfile->data->username]) ?>
                        <?= $this->tag->emailField(['email', 'size' => 32, 'class' => 'input-group', 'required' => true, 'value' => $viewProfile->data->email]) ?>
                        </div>
                    </div>
