...
{{ form ('lisa/upload/save', 'method' : 'post' ) }}
{{ hidden_field('documentId', 'class':'input-group', 'value': editDetail.data.documentId ) }}
<div class=" row detail">
    ...
    <div class="col-9">
        {{ text_field('title', 'class':'input-group', 'value': editDetail.data.title ) }}
        <label>
        ...
        {{ text_field('receiver', 'class':'input-group', 'value': editDetail.data.receiver ) }}
        {{ text_field('sendAddress', 'class':'input-group', 'value': editDetail.data.sendAddress ) }}
    </div>
    ...
    <div class="menuBar">
        ...
        {{ submit_button('บันทึกเอกสาร', 'class':'save_btn')}}
    </div>
</div>

<div id="signPageField" style="margin-top: 100px; display: none;">
    {{ hidden_field('documentId', 'class':'input-group', 'value': editDetail.data.documentId , 'id':'documentId') }}
    <div style="overflow-x:auto;">
        <div id="table" class="page">
            {% for key, i in viewPage %}
    ...
    <div class="text-center" style="float: right; margin: 30px auto;">
        {{ submit_button('สกัดชื่อผู้ลงนาม', 'class':'save_btn extractSignature', 'id':'extractSignature')}}
    </div>
</div>
    <script>
